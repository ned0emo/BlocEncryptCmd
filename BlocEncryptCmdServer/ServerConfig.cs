...
namespace BlocEncryptCmdServer
{
    ...
    {
        //public const string userNameCfg = "User";
        //public const string chatSecretCfg = "ChatSecret";
        //public const string passwordSecretCfg = "PasswordSecret";
        ...
        public async Task LoadConfig()
        {
            ...
            if (!configs.ContainsKey(ConfigKey.PasswordSecret.ToString()))
            {
                Console.WriteLine("Введите кодовое слово для шифрования пароля (кириллица, только заглавные буквы):");
                string? secret;
                do
                {
                    secret = Console.ReadLine();
                ...
                configs.Add(ConfigKey.PasswordSecret.ToString(), secret);
            }
